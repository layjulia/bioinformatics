...
## A. Install packages if required
...
##### 2.3.1. Calculate the length of all coding sequences in these two organisms.
...
##### 2.4.4. Create bar plots for amino acid count
