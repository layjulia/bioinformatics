...
We can then visualise via another combined bar plot of RSCU values for both organisms together with RSCU = 1 shown as a dashed red line. We can already see that the codon with the largest RSCU value is the _ctg_ codon for both organisms.
```{r}
...
Bar color corresponds to the codon for each amino acid
```{r}
